        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Coordinate_Latitude_Range1", "[Latitude] >= -90 AND [Latitude] <= 90");
                    table.CheckConstraint("CK_Coordinate_Longitude_Range1", "[Longitude] >= -180 AND [Longitude] <= 180");
                    table.ForeignKey(
